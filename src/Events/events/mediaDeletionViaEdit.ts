...
export default class ModerationPingEvent extends BotEvent {
    ...
    async execute(services: Services, oldMessage: Message, newMessage: Message) {
        ...
        try {
            ...
            await services.pager.sendError(error, "Trying to log deleted attachments as part of a message edit.", services.state.state.pagedUsers, { services, oldMessage, newMessage });
