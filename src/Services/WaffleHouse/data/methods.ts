...
export const SCORING_METHODS: ScoringMethod[] = [
    ...
    { id: "w4ff13sp34k",            name: "W4ff13sp34k",            points: 10,   cooldownMs: 5 * 60 * 1000 },
    { id: "eating_backwards",       name: "Eating Backwards",       points: 30,   cooldownMs: 15 * 60 * 1000 },
    { id: "waffle_fan",             name: "Waffle Fan",             points: 10,   cooldownMs: 5 * 60 * 1000 },
