...
export const waffleChannelIds = {
    counter: config.get<string>("waffleHouse.channelIds.counter"),
    house: config.get<string>("waffleHouse.channelIds.house"),
    noWaffle: config.get<string>("waffleHouse.channelIds.noWaffle"),
    blueyTalk: config.get<string>("waffleHouse.channelIds.blueyTalk"),
}
...
export const waffleEmojiIds = {
    blueyDerp: config.get<string>("waffleHouse.emojiIds.blueyDerp"),
}
