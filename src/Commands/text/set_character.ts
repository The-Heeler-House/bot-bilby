...
export default class SetCharacterCommand extends TextCommand {
    ...
    async execute(message: Message, args: string[], services: Services) {
        ...
        try {
            ...
            await services.pager.sendError(error, "Trying to change avatar and username to character " + args.join(" "), services.state.state.pagedUsers, { message, args, character, services });
